...
const MainPage = () => {
  return (
    <div className=" w-full h-svh flex justify-center items-center bg-black bg-cover bg-no-repeat bg-[url('/coverpage.png')] backdrop-blur-sm">
      {/* <Helmet>
      ...
      <div className="flex justify-center items-center h-full w-full z-60 text-black">
