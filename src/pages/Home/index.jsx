...
const Home = () => {
  return (
    <div className=" w-full h-svh flex justify-center items-center bg-black  backdrop-blur-sm">
      ...
      <header
        className={` text-white sm:px-10 px-4 py-4 sm:py-2 z-70 flex top-0 justify-between  fixed w-full  items-center duration-75 ease-in`}
      >
        <Link to="/">
        ...
        <Link to="/login">
          <div className=" flex justify-center items-center cursor-pointer px-4 py-2 bg-indigo-600 font-bold group hover:scale-105 duration-75 ease-in  rounded">
            Login
          </div>
        </Link>
      </header>
      <div className="flex justify-center items-center h-full w-full z-60 ">
        ...
        <div className=" p-8 rounded-lg  w-full flex flex-col gap-3 sm:gap-3  justify-center items-center relative select-none text-shadow-2xs text-shadow-black">
          ...
          <Link to="/register">
            <button className=" relative flex justify-center text-white font-bold items-center cursor-pointer px-6 py-2 bg-indigo-600 group duration-75 ease-in   hover:scale-105 rounded">
              Get Started
